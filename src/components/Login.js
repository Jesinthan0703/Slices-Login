...
import { login, loginFailed,setIsButtonDisabled } from '../Slices/loginSlice';
...
const loginFunction= (e)=>{
    ...
    if (name === 'jesin@pattarai.in' && password === 'licet@123')
    {
        dispatch(
        login({
        name:name,
        ...
        <form className={classes.container} noValidate autoComplete="off">
            ...
            <CardHeader className={classes.header} title="Crew Login"/>
            <CardContent>
                <div>
                    <TextField
                    fullWidth
